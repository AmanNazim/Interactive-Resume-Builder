var SkillsListManager = /** @class */ (function () {
    function SkillsListManager(inputList, /*getSkillInputs(): NodeListOf<HTMLInputElement>,*/ addButton, maxAdds) {
    ...
    SkillsListManager.prototype.eventInitialize = function () {
        var _this = this;
        this.inputAddButton.addEventListener('click', function () { _this.addSkillsInputs(); });
        this.skillsInputList.addEventListener('keydown', function (event) { _this.backspaceInputsRemove(event); });
    };
...
document.addEventListener('DOMContentLoaded', function () {
    var skillsListManager = new SkillsListManager(skillsInputList, /*skillsInputs,*/ inputsAddButton, maxInputsAddition);
});
