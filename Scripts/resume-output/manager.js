...
var DownloadManager = /** @class */ (function () {
  ...
  DownloadManager.prototype.setupDownloadListeners = function () {
    ...
    if (confirmBtn) {
      confirmBtn.addEventListener("click", function () {
        var _a;
        var format =
          ((_a = _this.modal.querySelector("#format")) === null || _a === void 0
            ? void 0
            : _a.value) || "pdf";
        if (format === "pdf") {
    ...
    if (overlay) {
      overlay.addEventListener("click", function (e) {
        if (e.target === overlay) _this.closeModal();
      });
    }
  };
  // Open modal
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            themeNumber =
              ((_a = new URLSearchParams(window.location.search).get(
                "theme"
              )) === null || _a === void 0
                ? void 0
                : _a.slice(-1)) || "1";
            htmlElement = document.getElementById(
              "resume".concat(themeNumber, "-output")
            );
            if (!htmlElement) return [2 /*return*/];
  ...
  DownloadManager.prototype.generatePng = function () {
    ...
    var themeNumber =
      ((_a = new URLSearchParams(window.location.search).get("theme")) ===
        null || _a === void 0
        ? void 0
        : _a.slice(-1)) || "1";
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (!previewContainer || !element) return [2 /*return*/];
            _b.label = 1;
          case 1:
            _b.trys.push([1, 3, , 4]);
...
var ShareManager = /** @class */ (function () {
  ...
  ShareManager.prototype.extractUserName = function () {
    ...
    if (profileNameElement) {
      var user =
        (_a = profileNameElement.textContent) === null || _a === void 0
          ? void 0
          : _a.trim(); // Get the name from the heading and trim it
  ...
  ShareManager.prototype.setupShareListeners = function () {
    ...
    shareButtons.forEach(function (btn) {
      btn.addEventListener("click", function (e) {
        return _this.shareOnPlatform(e);
      });
    });
  ...
  ShareManager.prototype.generateUniqueResumeLink = function () {
    ...
    var uniqueResumeLink = ""
      .concat(baseUrl, "?user=")
      .concat(encodedUserName, "&id=")
      .concat(encodedUniqueId);
  ...
  ShareManager.prototype.shareOnPlatform = function (event) {
    ...
    var urls = {
      whatsapp: "https://api.whatsapp.com/send?text="
        .concat(text, "%20")
        .concat(url),
      linkedin: "https://www.linkedin.com/sharing/share-offsite/?url=".concat(
        url
      ),
...
var EditManager = /** @class */ (function () {
  ...
  EditManager.prototype.setupEditListeners = function () {
    ...
    (_a = document.getElementById("edit-btn")) === null || _a === void 0
      ? void 0
  ...
  EditManager.prototype.saveChanges = function () {
    ...
    var data = {
      profile: {
        name:
          ((_a = document.querySelector(".profile-name")) === null ||
          _a === void 0
            ? void 0
            : _a.textContent) || "",
        email:
          ((_b = document.querySelector(".em-span")) === null || _b === void 0
            ? void 0
            : _b.textContent) || "",
        contact:
          ((_c = document.querySelector(".con-span")) === null || _c === void 0
            ? void 0
            : _c.textContent) || "",
        address:
          ((_d = document.querySelector(".Add-span")) === null || _d === void 0
            ? void 0
            : _d.textContent) || "",
        profileText:
          ((_e = document.querySelector(".profile-description")) === null ||
          _e === void 0
            ? void 0
            : _e.textContent) || "",
      },
      education:
        ((_f = document.querySelector(".education-content")) === null ||
        _f === void 0
          ? void 0
          : _f.textContent) || "",
      experience:
        ((_g = document.querySelector(".experience-content")) === null ||
        _g === void 0
          ? void 0
          : _g.textContent) || "",
  ...
  EditManager.prototype.loadProfile = function () {
    ...
    if (storedData) {
      ...
      document.querySelector(".profile-description").textContent =
        ((_e = data.profile) === null || _e === void 0
          ? void 0
          : _e.profileText) || "";
      ...
      if (skillsList_1) {
        (_f = data.skills) === null || _f === void 0
          ? void 0
          : _f.forEach(function (skill) {
      ...
      if (languagesList_1) {
        (_g = data.languages) === null || _g === void 0
          ? void 0
          : _g.forEach(function (language) {
              var li = document.createElement("li");
